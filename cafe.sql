...
CREATE TABLE `cart_items` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_item` (`cart_id`,`variant_id`),
...
CREATE TABLE `orders` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `status` enum('pending','preparing','delivered','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `product_variants` (
  ...
  CONSTRAINT `product_variants_chk_2` CHECK ((`available_quantity` >= 0))
...
-- Dump completed on 2026-07-03 21:01:32
